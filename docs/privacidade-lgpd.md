...
DETRAN SP: Débitos e Restrições segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [detran_sp_debitos@mcp.ai](mailto:detran_sp_debitos@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
